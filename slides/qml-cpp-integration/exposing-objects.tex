...
\vspace*{0.5em}
\begin{itemize}
\item \qtt{Ellipse} has a \qtt{setColor()} method
  \begin{itemize}
...
\item Classes can be used as property types
  ...
  \item subclass \iCls{QObject} (as before)
...
\begin{itemize}
\item \qtt{Style} is a \iCls{QObject} subclass
...
\item Define classes as property types:
  \begin{itemize}
  \item declare and implement a new \iCls{QObject} subclass
