...
%----------------------------------------------------------------------
\begin{slide}[fragile]{0798}\frametitle{Custom Slots - the Qt4 style}
 \label{codeForSlots1}
\xConcept{connect}
\xConcept{Q\_OBJECT}
\begin{itemize}
...
%----------------------------------------------------------------------
\begin{slide}[fragile]{1031}\frametitle{Inlined code}
  \begin{itemize}
\item Using functors:\\
\begin{cpp}
static void printValue(int value) {
...
\end{cpp}
\end{itemize}
\demo{object-communication/ex-connect-functors}\bigskip\bigskip
