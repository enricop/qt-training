...
%----------------------------------------------------------------------
\begin{slide}[fragile]{1030}\frametitle{connect - member functions}
  \begin{itemize}
...
%----------------------------------------------------------------------
\begin{slide}[fragile]{1033}\frametitle{connect - signal/slot macros}
  \begin{itemize}
...
%----------------------------------------------------------------------
\begin{slide}[fragile]{0798}\frametitle{Custom Slots - Traditional style}
 \label{codeForSlots1}
\xConcept{connect}
\xConcept{Q\_OBJECT}
\begin{itemize}
...
%----------------------------------------------------------------------
\begin{slide}[fragile]{1031}\frametitle{connect - non-member functions}
  \begin{itemize}
\item Using non-member functions:\\
\begin{cpp}
static void printValue(int value) {
...
\item[]\disadvantage Not supported on all compilers
  \end{itemize}
...
\item \textbf{\texttt{Q\_OBJECT}}
  ...
  \item Required for properties
  \item Required for signals
  \item Required for slots when using the traditional method
  \end{itemize}\medskip
...
c++ -o myapp moc_myclass.o myclass.o
 ...
 \item \textbf{qmake} takes care of \textit{moc}ing files for you
\end{itemize}
