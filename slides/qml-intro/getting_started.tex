...
\vspace*{1em}
\begin{itemize}
\item To use Qt's features, \qic{keyword}{import} the \qic{class}{QtQuick} module
...
\item A set of default elements are included in the \texttt{\qc{class}{QtQuick}} module
\end{itemize}
