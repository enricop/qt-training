...
\begin{slide}{1465}\frametitle{Drag and Drop in Views}

\begin{qml}
\qtt{\qc{class}{DropArea}~\{}\\
\qtt{~~~~\qc{type}{anchors.fill}:~{parent}}\\
\qtt{~~~~\qc{type}{onEntered}:~\{}\\
\qtt{~~~~~~~~visualModel.items.move(...)}\\
\qtt{~~~~\}}\\
\qtt{\}}
\end{qml}
...
\qtt{~~~~\qc{type}{Drag.active}:~{mouseArea.held}}\\
\qtt{\}}
\end{qml}
