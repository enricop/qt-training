...
\qtt{~~~~~~~~\qc{type}{name}:~\qc{string}{"with~text"}}\\
\qtt{~~~~~~~~\qc{type}{when}:~text\_field.text~\qc{operator}{!=}~""}\\
\qtt{~~~~~~~~\qc{lightgray}{PropertyChanges~\{}\\
\qtt{~~~~~~~~~~~~\qc{lightgray}{target:~clear\_button;~opacity:~1.0~\}}}}\\
\qtt{~~~~~~\},}
\end{qml}
\flushedImage{qml-states-transitions/images/state-conditions-without-text.pdf}
\begin{qml}
...
\qtt{~~~~~~~~\qc{type}{when}:~text\_field.text~\qc{operator}{==}~""}\\
\qtt{~~~~~~~~\qc{lightgray}{PropertyChanges~\{}\\
\qtt{~~~~~~~~~~~~\qc{lightgray}{target:~clear\_button;~opacity:~0.25~\}}}}\\
\qtt{~~~~~~~~\qc{lightgray}{PropertyChanges~\{}\\
\qtt{~~~~~~~~~~~~\qc{lightgray}{target:~text\_field;~focus:~true~\}}}}\\
\qtt{~~~~~~\}}\\
\end{qml}
